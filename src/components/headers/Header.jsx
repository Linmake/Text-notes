import '../../sass/components/headers/css/HeaderComponent.css'
      ...
      <nav className="navbar navbar-expand-lg bg-body-tertiary" id='header'>
        <div className="container-fluid" id='navContend'>
          ...
          <form className="d-flex" role="search" id='form-search'>
            <input className="form-control me-2" type="search" placeholder="Search" aria-label="Search" id="input-search" />
